* Error: Detected dangling id-reference to ios from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[6]""/f-element[3]""/aactivity[1]""/Tests[1]"Condition"/h:div[1]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to android from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[1]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to windows from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[2]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to ios from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[3]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to linux from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[4]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to Solaris from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[5]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to mac from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[1]""/aactivity[1]""/Tests[1]"If a cont"/h:div[6]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to android from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[2]""/aactivity[1]""/Tests[1]""/h:div[1]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to ios from attribute
        ref/PP[1]""/sec:req[1]""/sec:SFRs[1]""/section[3]""/f-component[7]""/f-element[2]""/aactivity[1]""/Tests[1]""/h:div[2]"The evalu"/depends[1]""/ref[1]""
* Error: Detected dangling id-reference to android from attribute
